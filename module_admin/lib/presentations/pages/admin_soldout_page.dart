...
class AdminSoldoutPage extends StatefulWidget {
  final Function(String?)? onDetailTap;
  const AdminSoldoutPage({super.key, this.onDetailTap});

  @override
  State<AdminSoldoutPage> createState() => _AdminSoldoutPageState();
}

class _AdminSoldoutPageState extends State<AdminSoldoutPage> {
  @override
  void initState() {
    super.initState();
                ...
                SliverPadding(
                  ...
                  sliver: SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      ...
                      childCount: state.products.where((p) => p.totalStok == 0).length,
                    ),
                  ),
                ),
